...
from.models import Booking_mak,Booking_dec,Booking_inv,Booking_cat,Booking_gif,Booking_jew,Booking_ven,Booking_cho,Booking_pho,Booking_meh,Booking_djs
from.models import *
